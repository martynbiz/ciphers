export default class MultiplicativeCipher {
  ...
  description = `<p>A multiplicative cipher is a type of <a href="https://en.wikipedia.org/wiki/Substitution_cipher">substitution cipher</a> where each letter in the plaintext is multiplied by a fixed number (the key) modulo 26 to produce the ciphertext.</p>
  ...
  #multiplicativeCipherDecrypt(character, key) {
    ...
    const modInverseKey = modularInverse(key, 0x110000);  // Find the modular inverse modulo the Unicode range
